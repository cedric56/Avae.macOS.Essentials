...
namespace Microsoft.Maui.ApplicationModel
{
	...
	static class CVDisplayLinkInterop
	{
		...
		public static double GetRefreshRate(uint display)
		{
			...
			using var dl = new CVDisplayLink();
...
#pragma warning restore CS0618 // Type or member is obsolete
        ...
        internal static CFRunLoopSource CreatePowerSourceNotification(Action callback)
        {
            ...
            object[] parameters = { sourceRef, true };
            object instantiatedType =
              Activator.CreateInstance(typeof(CFRunLoopSource), flags, null, parameters, culture);
            return (CFRunLoopSource)instantiatedType;// Activator.CreateInstance(typeof(CFRunLoopSource), sourceRef, true);
        }
